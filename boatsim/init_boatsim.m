%% INITIALIZATION SCRIPT FOR ASV
% Modify all user-defined hyperparameters for NeuralPARC in this script.
%
% This script is written for the ASV example.
%
% REQUIRED VARIABLES:
% --- directory options ---
...
% Parameter domains
% For ASV, k(1) is p_x_g, x-coordinate of desired goal
%          k(2) is p_y_g, y-coordinate of desired goal
%          k(3) is theta_0, initial heading of the ASV
% Lower bound
k_lo = [4; -1; -pi./6];
...
isAnytime = true; % Terminate early if safe sample found
